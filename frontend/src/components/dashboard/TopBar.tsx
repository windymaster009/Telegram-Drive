...
export function TopBar({
    currentFolderName, selectedIds, onShowMoveModal, onShowCopyModal, onBulkDownload, onBulkDelete,
            ...
            <div className="flex items-center gap-2">
                {selectedIds.length > 0 && (
                    <div className="flex items-center gap-2 mr-4 animate-in fade-in slide-in-from-top-2">
                        ...
                        {canCopy && <button onClick={onShowCopyModal} className="px-3 py-1.5 bg-telegram-primary/20 hover:bg-telegram-primary/30 text-telegram-primary rounded-md text-xs transition font-medium">Copy to...</button>}
